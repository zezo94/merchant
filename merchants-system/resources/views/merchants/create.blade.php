    ...
    @can('create merchants')
        <div class="container py-4">
            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
                <div>
                    <h2 class="mb-1">إضافة تاجر جديد</h2>
                    <p class="text-muted mb-0">أدخل البيانات الأساسية ووسائل الاتصال ثم احفظ السجل</p>
                </div>
            ...
            <form action="{{ route('merchants.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="membership_no" class="form-control" value="{{ old('membership_no') }}">
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="commercial_name" class="form-control" value="{{ old('commercial_name') }}">
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">رقم السجل التجاري</label>
                                <input type="text" name="commercial_reg_no" class="form-control" value="{{ old('commercial_reg_no') }}">
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">الرقم الوطني</label>
                                <input type="text" name="org_national_no" class="form-control" value="{{ old('org_national_no') }}">
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">القطاع</label>
                                <input type="text" name="sector" class="form-control" value="{{ old('sector') }}" placeholder="اكتب اسم القطاع">
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">تاريخ التسجيل</label>
                                <input type="date" name="registered_date" class="form-control" value="{{ old('registered_date') }}">
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">تاريخ الاشتراك</label>
                                <input type="date" name="sub_date" class="form-control" value="{{ old('sub_date') }}">
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">تاريخ السجل التجاري</label>
                                <input type="date" name="commercial_reg_date" class="form-control" value="{{ old('commercial_reg_date') }}">
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">CCateID</label>
                                <input type="text" name="ccate_id" class="form-control" value="{{ old('ccate_id') }}">
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">المفوّض بالتوقيع</label>
                                <input type="text" name="delegate_to_sign_on_management" class="form-control" value="{{ old('delegate_to_sign_on_management') }}">
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">الأعضاء / الشركاء</label>
                                <input type="text" name="members" class="form-control" value="{{ old('members') }}">
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" name="zipcode_desc" class="form-control" value="{{ old('zipcode_desc') }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                <div class="form-check mt-4">
                                    <input type="checkbox" name="contacted" class="form-check-input" id="contacted" {{ old('contacted') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3">
                                <div class="form-check mt-4">
                                    <input type="checkbox" name="invited" class="form-check-input" id="invited" {{ old('invited') ? 'checked' : '' }}>
                ...
                <div class="card section-card mb-4">
                    ...
                    <div class="card-body">
                        <div id="mobiles-container">
                            @php $oldMobiles = old('mobiles', ['']); @endphp
                            @foreach($oldMobiles as $mobile)
                                <div class="dynamic-item d-flex gap-2">
                ...
                <div class="card section-card mb-4">
                    ...
                    <div class="card-body">
                        <div id="faxes-container">
                            @php $oldFaxes = old('faxes', ['']); @endphp
                            @foreach($oldFaxes as $fax)
                                <div class="dynamic-item d-flex gap-2">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    <button type="submit" class="btn btn-success">حفظ التاجر</button>
                    <a href="{{ route('merchants.index') }}" class="btn btn-secondary">إلغاء</a>
                </div>
            </form>
        </div>
    @else
        <div class="alert alert-danger">ليس لديك صلاحية إضافة تاجر.</div>
    @endcan
@endsection
